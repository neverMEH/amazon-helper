...
from amc_manager.api.ai_insights import router as ai_insights_router
...
app.include_router(ai_insights_router)  # Already has /api/ai prefix in router definition
