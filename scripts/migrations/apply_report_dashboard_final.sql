-- Collection Report Dashboard Schema - Final Migration
-- Fixed: Removed now() function from index WHERE clause (must be IMMUTABLE)
-- Date: 2025-09-10
...
-- 3. Add columns to report_data_collections
...
-- 4. Add column to report_data_weeks
...
-- 7. Create RLS policies for collection_report_configs
...
-- 8. Create RLS policies for collection_report_snapshots
