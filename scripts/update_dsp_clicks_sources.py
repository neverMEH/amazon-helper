#!/usr/bin/env python3
"""
Update DSP Clicks data sources in AMC
"""
...
# Define the DSP Clicks data sources
dsp_clicks_sources = [
    {
        "schema_id": "dsp_clicks",
        "name": "Amazon DSP Clicks",
        "description": "Analytics table that is a subset of the dsp_impressions information that captures the impressions that were clicked and the associated click related information.",
        "category": "DSP",
        "table_type": "Analytics"
    },
    {
        "schema_id": "dsp_clicks_for_audiences",
        "name": "Amazon DSP Clicks for Audiences",
        "description": "Audience table that is a subset of the dsp_impressions information that captures the impressions that were clicked and the associated click related information.",
        "category": "DSP",
        "table_type": "Audience"
    }
]

# Define the fields for DSP clicks tables
dsp_clicks_fields = [
    # Dimensions
    ...
    {"name": "advertiser_id", "data_type": "LONG", "field_type": "Dimension", "description": "ID of the Amazon DSP advertiser associated with the click event. Example value: '123456789012345'.", "aggregation_threshold": "LOW"},
    ...
    {"name": "app_bundle", "data_type": "STRING", "field_type": "Dimension", "description": "The app bundle ID associated with the Amazon DSP click event. App bundles follow different formatting conventions depending on the app store.", "aggregation_threshold": "LOW"},
    ...
    {"name": "campaign_id", "data_type": "LONG", "field_type": "Dimension", "description": "The ID of the Amazon DSP campaign responsible for the click event. In this table, campaign_id and campaign_id_string fields will show the same value for a given event. Example value: '571234567890123456'.", "aggregation_threshold": "LOW"},
    {"name": "campaign_id_string", "data_type": "STRING", "field_type": "Dimension", "description": "The ID of the Amazon DSP campaign responsible for the click event. In this table, campaign_id and campaign_id_string fields will show the same value for a given event. Example value: '571234567890123456'.", "aggregation_threshold": "LOW"},
    {"name": "campaign_insertion_order_id", "data_type": "STRING", "field_type": "Dimension", "description": "ID of the insertion order associated with the Amazon DSP click event. An insertion order is a contractual agreement between an advertiser and Amazon Ads that outlines the specific details of a programmatic advertising campaign. Example value: '123456789'.", "aggregation_threshold": "LOW"},
    ...
    {"name": "campaign_sales_type", "data_type": "STRING", "field_type": "Dimension", "description": "Billing classification of the Amazon DSP campaign, which distinguishes billable and non-billable campaigns. Example values include: 'BILLABLE' and 'BONUS'.", "aggregation_threshold": "LOW"},
    ...
    {"name": "campaign_status", "data_type": "STRING", "field_type": "Dimension", "description": "Current status of the Amazon DSP campaign. Campaign status indicates whether a campaign is actively delivering ads, has completed its flight dates, or has been paused by the advertiser. Example values include: 'ENDED', 'RUNNING', 'ENABLED', 'PAUSED', and 'ADS_NOT_RUNNING'.", "aggregation_threshold": "LOW"},
    {"name": "city_name", "data_type": "STRING", "field_type": "Dimension", "description": "City name where the Amazon DSP click event occurred, determined by signal available in the auction event. Example value: 'New York'.", "aggregation_threshold": "HIGH"},
    {"name": "click_date", "data_type": "DATE", "field_type": "Dimension", "description": "Date of the Amazon DSP click event in advertiser timezone. This field will be populated for conversion events that are attributed to an ad view. Example value: '2025-01-01'.", "aggregation_threshold": "LOW"},
    {"name": "click_date_utc", "data_type": "DATE", "field_type": "Dimension", "description": "Date of the Amazon DSP click event in Coordinated Universal Time (UTC). This field will be populated for conversion events that are attributed to an ad view. Example value: '2025-01-01'", "aggregation_threshold": "LOW"},
    {"name": "click_day", "data_type": "INTEGER", "field_type": "Dimension", "description": "Day of month when the Amazon DSP click event occurred in advertiser timezone. Example value: '1'.", "aggregation_threshold": "LOW"},
    {"name": "click_day_utc", "data_type": "INTEGER", "field_type": "Dimension", "description": "Day of month when the Amazon DSP click event occurred in Coordinated Universal Time (UTC). Example value: '1'.", "aggregation_threshold": "LOW"},
    {"name": "click_dt", "data_type": "TIMESTAMP", "field_type": "Dimension", "description": "Timestamp of the Amazon DSP click event in advertiser timezone. This field will be populated for conversion events that are attributed to an ad view. Example value: '2025-01-01T12:00:00.000Z'.", "aggregation_threshold": "MEDIUM"},
    {"name": "click_dt_hour", "data_type": "TIMESTAMP", "field_type": "Dimension", "description": "Timestamp of the Amazon DSP click event in advertiser timezone, truncated to hour. This field will be populated for conversion events that are attributed to an ad view. Example value: '2025-01-01T12:00:00.000Z'.", "aggregation_threshold": "LOW"},
    {"name": "click_dt_hour_utc", "data_type": "TIMESTAMP", "field_type": "Dimension", "description": "Timestamp of the Amazon DSP click event in Coordinated Universal Time (UTC), truncated to hour. This field will be populated for conversion events that are attributed to an ad view. Example value: '2025-01-01T12:00:00.000Z'.", "aggregation_threshold": "LOW"},
    {"name": "click_dt_utc", "data_type": "TIMESTAMP", "field_type": "Dimension", "description": "Timestamp of the Amazon DSP click event in Coordinated Universal Time (UTC). This field will be populated for conversion events that are attributed to an ad view. Example value: '2025-01-01T00:00:00.000Z'.", "aggregation_threshold": "MEDIUM"},
    {"name": "click_hour", "data_type": "INTEGER", "field_type": "Dimension", "description": "Hour of day when the Amazon DSP click event occurred, in advertiser timezone. Values range from 0-23 representing 24-hour time. Example value: '14' (represents 2:00 PM in 24-hour time).", "aggregation_threshold": "LOW"},
    {"name": "click_hour_utc", "data_type": "INTEGER", "field_type": "Dimension", "description": "Hour of day when the Amazon DSP click event occurred, in Coordinated Universal Time (UTC). Values range from 0-23 representing 24-hour time. Example value: '14' (represents 2:00 PM in 24-hour time).", "aggregation_threshold": "LOW"},
    ...
    {"name": "demand_channel", "data_type": "STRING", "field_type": "Dimension", "description": "Demand channel name.", "aggregation_threshold": "LOW"},
    ...
    {"name": "device_id", "data_type": "STRING", "field_type": "Dimension", "description": "Pseudonymized ID representing the device associated with the Amazon DSP click event.", "aggregation_threshold": "VERY_HIGH"},
    {"name": "device_make", "data_type": "STRING", "field_type": "Dimension", "description": "Manufacturer or brand name of the device associated with the Amazon DSP click event, derived from user-agent in the auction. Values may appear in different formats or capitalizations for the same manufacturer. Example values: 'Apple', 'APPLE', 'Samsung', 'SAMSUNG', 'ROKU', 'Generic', 'UNKNOWN'.", "aggregation_threshold": "LOW"},
    {"name": "device_model", "data_type": "STRING", "field_type": "Dimension", "description": "Model of the device associated with the Amazon DSP click event, derived from user-agent in the auction. Values may appear in different formats or capitalizations for the same manufacturer. Example values: 'iPhone', 'GALAXY'.", "aggregation_threshold": "LOW"},
    {"name": "device_type", "data_type": "STRING", "field_type": "Dimension", "description": "Type of the device associated with the Amazon DSP click event. Possible values include: 'Tablet', 'Phone', 'TV', 'PC', 'ConnectedDevice', 'Unknown', and NULL.", "aggregation_threshold": "LOW"},
    ...
    {"name": "entity_id", "data_type": "STRING", "field_type": "Dimension", "description": "ID of the Amazon DSP entity (also known as seat) associated with the click. An entity represents an Amazon DSP account, within which media is further organized by advertiser and by campaign. Example value: 'ENTITYABC123XYZ789'.", "aggregation_threshold": "LOW"},
    {"name": "environment_type", "data_type": "STRING", "field_type": "Dimension", "description": "Environment where the Amazon DSP click event occurred. This field distinguishes between web-based environments like desktop or mobile browsers, and app-based environments like mobile apps. If the environment type cannot be determined, this field will be NULL. Example values include: 'Web', 'App', and NULL.", "aggregation_threshold": "LOW"},
    ...
    {"name": "impression_day", "data_type": "INTEGER", "field_type": "Dimension", "description": "Day of month when the Amazon DSP impression event occurred in advertiser timezone. Example value: '1'.", "aggregation_threshold": "LOW"},
    ...
    {"name": "impression_dt", "data_type": "TIMESTAMP", "field_type": "Dimension", "description": "Timestamp of the Amazon DSP impression event in advertiser timezone. Example value: '2025-01-01T12:00:00.000Z'.", "aggregation_threshold": "MEDIUM"},
    {"name": "impression_dt_hour", "data_type": "TIMESTAMP", "field_type": "Dimension", "description": "Timestamp of the Amazon DSP impression event in advertiser timezone, truncated to hour. Example value: '2025-01-01T12:00:00.000Z'.", "aggregation_threshold": "LOW"},
    ...
    {"name": "impression_dt_utc", "data_type": "TIMESTAMP", "field_type": "Dimension", "description": "Timestamp of the Amazon DSP impression event in Coordinated Universal Time (UTC). Example value: '2025-01-01T00:00:00.000Z'.", "aggregation_threshold": "MEDIUM"},
    {"name": "impression_hour", "data_type": "INTEGER", "field_type": "Dimension", "description": "Hour of day when the Amazon DSP impression event occurred, in advertiser timezone. Values range from 0-23 representing 24-hour time. Example value: '14' (represents 2:00 PM in 24-hour time).", "aggregation_threshold": "LOW"},
    ...
    {"name": "iso_country_code", "data_type": "STRING", "field_type": "Dimension", "description": "ISO 3166 Alpha-2 country code where the Amazon DSP click event occurred, based on the user's IP address. Example value: 'US'.", "aggregation_threshold": "LOW"},
    ...
    {"name": "is_amazon_owned", "data_type": "BOOLEAN", "field_type": "Dimension", "description": "Boolean value indicating whether or not the Amazon DSP click occurred on Amazon-owned inventory. Amazon-owned inventory includes media such as Prime Video, IMDb, and Twitch. Example values for this field are: 'true', 'false'.", "aggregation_threshold": "LOW"},
    {"name": "line_item", "data_type": "STRING", "field_type": "Dimension", "description": "Name of the Amazon DSP line item responsible for the click event. Attributes like ad format and targeting are defined at line item level within a campaign. Example value: 'Widgets - DISPLAY - O&O - RETARGETING'.", "aggregation_threshold": "LOW"},
    ...
    {"name": "line_item_end_date_utc", "data_type": "TIMESTAMP", "field_type": "Dimension", "description": "End date and time of the line item in Coordinated Universal Time (UTC). Example value: '2025-01-01T23:59:59.000Z'.", "aggregation_threshold": "LOW"},
    {"name": "line_item_id", "data_type": "LONG", "field_type": "Dimension", "description": "ID of the Amazon DSP line item responsible for the click event. Attributes like ad format and targeting are defined at line item level within a campaign. Example value: '5812345678901234'.", "aggregation_threshold": "LOW"},
    ...
    {"name": "no_3p_trackers", "data_type": "BOOLEAN", "field_type": "Dimension", "description": "Boolean value indicating whether the event can be used for audience creation that is third-party tracking enabled (i.e. whether you can serve creative with third-party tracking when running media against the audience). Third-party tracking refers to measurement tags and pixels from external vendors that can be used to measure ad performance. Example values for this field are: 'true', 'false'.", "aggregation_threshold": "NONE"},
    {"name": "operating_system", "data_type": "STRING", "field_type": "Dimension", "description": "Operating system of the device where the Amazon DSP click event occurred. Example values: 'iOS', 'Android', 'Windows', 'macOS', 'Roku OS'.", "aggregation_threshold": "LOW"},
    {"name": "os_version", "data_type": "STRING", "field_type": "Dimension", "description": "Operating system version of the device where the Amazon DSP click event occurred. The version format varies by operating system type. Example value: '17.5.1'.", "aggregation_threshold": "LOW"},
    {"name": "page_type", "data_type": "STRING", "field_type": "Dimension", "description": "Type of page where the Amazon DSP click event occurred. This grain of detail is primarily relevant to impressions served on Amazon sites. Example values: 'Search', 'Detail', 'CustomerReviews'.", "aggregation_threshold": "LOW"},
    {"name": "postal_code", "data_type": "STRING", "field_type": "Dimension", "description": "Postal code in which the Amazon DSP click event occurred, based on the user's IP address. Postal code is also referred to as \"zip code\" in the US. The postal code is prepended with the iso_country_code value (e.g. 'US'). If the country is known, but the postal code is unknown, only the country code will be populated in postal_code. Example value: 'US-12345'.", "aggregation_threshold": "HIGH"},
    {"name": "product_line", "data_type": "STRING", "field_type": "Dimension", "description": "Campaign product line.", "aggregation_threshold": "LOW"},
    {"name": "publisher_id", "data_type": "STRING", "field_type": "Dimension", "description": "ID of the publisher on which the Amazon DSP click event occurred. A publisher is the media owner (such as a website, app, or streaming service owner) that makes advertising inventory available for purchase through Amazon DSP.", "aggregation_threshold": "LOW"},
    {"name": "request_dt", "data_type": "TIMESTAMP", "field_type": "Dimension", "description": "Timestamp of the request event in advertiser timezone. Example value: '2025-01-01T00:00:00.000Z'.", "aggregation_threshold": "MEDIUM"},
    {"name": "request_dt_hour", "data_type": "TIMESTAMP", "field_type": "Dimension", "description": "Timestamp of the request event in advertiser timezone, truncated to hour. Example value: '2025-01-01T12:00:00.000Z'.", "aggregation_threshold": "LOW"},
    {"name": "request_dt_hour_utc", "data_type": "TIMESTAMP", "field_type": "Dimension", "description": "Timestamp of the request event in Coordinated Universal Time (UTC), truncated to hour. Example value: '2025-01-01T12:00:00.000Z'.", "aggregation_threshold": "LOW"},
    {"name": "request_dt_utc", "data_type": "TIMESTAMP", "field_type": "Dimension", "description": "Timestamp of the request event in Coordinated Universal Time (UTC). Example value: '2025-01-01T00:00:00.000Z'.", "aggregation_threshold": "MEDIUM"},
    ...
    {"name": "site", "data_type": "STRING", "field_type": "Dimension", "description": "The site descriptor where the Amazon DSP click event occurred. A site can be any digital property where ads are served, including websites, mobile apps, and streaming platforms.", "aggregation_threshold": "LOW"},
    {"name": "supply_cost", "data_type": "STRING", "field_type": "Dimension", "description": "The cost (in microcents) that Amazon DSP pays a publisher or publisher ad tech platform (such as an SSP or exchange) for an impression. To convert supply_cost to dollars/your local currency, divide by 100,000,000 (e.g., 100,000,000 microcents = $1.00). Refer to the currency_name field for the currency in which the impression was purchased. Example value: '5000'.", "aggregation_threshold": "LOW"},
    ...
    {"name": "supply_source_id", "data_type": "STRING", "field_type": "Dimension", "description": "ID of the supply source from which the Amazon DSP impression was purchased. Supply sources can include Amazon-owned properties (like Amazon.com and Twitch), Amazon Publisher Services inventory, and third-party partners.", "aggregation_threshold": "LOW"},
    ...
    {"name": "clicks", "data_type": "LONG", "field_type": "Metric", "description": "Count of Amazon DSP clicks. When querying this table, remember that each record represents one Amazon DSP click, so you can use this field to calculate accurate click totals. Since this table only includes click events, this field will always have a value of '1' (the event was a click event).", "aggregation_threshold": "LOW"},
    {"name": "click_cost", "data_type": "LONG", "field_type": "Metric", "description": "Click cost (in millicents). To convert to dollars/local currency, divide by 100,000 (e.g., 100,000 millicents = $1.00). Refer to the currency_name field for the currency in which the click cost is reported. Example value: 300 (equivalent to $0.003).", "aggregation_threshold": "MEDIUM"},
...
def update_dsp_clicks():
    """Update DSP Clicks data sources"""
    
    print("\n=== Updating DSP Clicks Data Sources ===\n")
    
    # Update/Insert data sources
    for source in dsp_clicks_sources:
        try:
            ...
            print(f"  Documented {len(dsp_clicks_fields)} fields for {source['schema_id']}")
            
        except Exception as e:
            print(f"❌ Error updating {source['schema_id']}: {str(e)}")
            continue
    
    print("\n=== DSP Clicks Update Complete ===")
    
    # Verify the update
    print("\n=== Verification ===")
    for schema_id in ['dsp_clicks', 'dsp_clicks_for_audiences']:
